...
CXX=g++ -std=c++2a ${INC}
PACKAGES=qemu-bridge qemu-tap qemu-hostd qemu-launch qemu-stop qemu-reboot qemu-reservations qemu-interfaces qemu-powerdown
BUILDDIR=build
FLAGS=-o3
...
qemu-powerdown: main-powerdown.o src/qemu-images.o src/qemu-manage.o src/qemu-hypervisor.o libraries/json11/json11.o src/qemu-link.o
